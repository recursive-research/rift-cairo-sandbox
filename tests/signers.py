...
class MockEthSigner:
    """
    Utility for sending signed transactions to an Account on Starknet, like
    MockSigner, but using a secp256k1 signature.
    ...
    async def send_transactions(self, account, calls, nonce=None, max_fee=0):
        ...
        return (
            await account.__execute__(call_array, calldata, nonce).invoke(
